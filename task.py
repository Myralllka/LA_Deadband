...
#   ~ DeadBand control - even with filtered position you might have a slight movement of the object smth like 10-12cm and if you have predefined observing distance for your vehicle exactly 1 meter, you will oscilate around that point which may cause multiple tragic outcomes ( smth like your colleague hunting you in the desert because you destroyed the drone ).
